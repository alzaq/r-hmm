...
### 8. Pčechodova matice
Definuji si matici přechodu mezi stavy HLAS a TICHO. Jaká je pravděpodobnost přechodu ze stavu do stavu.
1 TICHO
2 HLAS
...
clusters <- kmeans(output, centers = pocetClusteru, iter.max = 5000)
...
```{r}
viter <- viterbi(hmm, clusters$cluster[1:8000]) #clusters$cluster[1:80]
print(viter)
