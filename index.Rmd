...
for (i in 1:length(files)) {
  ...
  #print(mapa[poleIndexu, 1]) # veta s useky
  
  #index(mapa, row = poleIndexu)
  #print(paste("VETA", poleIndexu, sep = " "))
...
### 8. Příprava HMM
```{r}
hmm <- initHMM(c("HLAS","SUM"),c("H","S"), transProbs=maticePrechodu, emissionProbs=matrix(c(.5,.51,.5,.49),2))
print(hmm)
```
